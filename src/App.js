...
class App extends React.Component {
  ...
  getWeather = async (e) => {
    ...
    const api_call = await fetch((`https://api.openweathermap.org/data/2.5/weather?q=${city},${country}&appid=${API_KEY}&units=metric`)/*`http://api.openweathermap.org/data/2.5/weather?q=${city}&mode=html&appid=${API_KEY}`*/);
